<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=200&text=Pouya%20Hadinejad&animation=fadeIn&fontColor=ffffff&fontSize=60" />
</div>

<h1 align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&pause=1000&color=00B8FF&center=true&vCenter=true&width=600&lines=AI+%26+Computer+Vision+Engineer;Full-Stack+%26+Mobile+Developer;Problem+Solver+%26+Tech+Enthusiast" alt="Typing SVG" />
</h1>
...
> معتقدم تکنولوژی باید در خدمت حل مسائل واقعی باشه. ترکیب **هوش مصنوعی**، **توسعه موبایل** و **بک‌اند مقیاس‌پذیر** نقطه قوت من برای ساخت محصولات هوشمند و کارآمد است.

- 🎯 تمرکز فعلی: **پردازش تصویر** و **بینایی ماشین** (Computer Vision)
- 🚀 عاشق ساخت اپلیکیشن‌های کراس پلتفرم با **Flutter** و **.NET**
- 🧩 علاقه‌مند به بهینه‌سازی الگوریتم‌های هوش مصنوعی برای استفاده در محیط‌های واقعی
...
<div align="center">
  ...
  <a href="mailto:pouya.hadinejad@example.com" target="_blank">
